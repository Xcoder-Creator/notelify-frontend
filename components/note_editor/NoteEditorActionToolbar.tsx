...
import BottomToolbarForNoteEditorDialog from '../dialog/BottomToolbarForNoteEditorDialog';
import DialogDropdownMenu from '../dialog/DialogDropdownMenu';
import BackgroundOptionsToolbarForDialog from '../dialog/BackgroundOptionsToolbarForDialog';

/**
 * This is the action toolbar for the note editor.
 * It includes buttons for formatting options, background options, 
 * adding images, archiving notes, and undo/redo actions.
 */
export default function NoteEditorActionToolbar({ editor, noteEditorPlaceholderRef, noteEditorAndTitleInputRef, backgroundOptionsButtonRef, backgroundOptionsToolbarRef, dropdownMenuRef, moreOptionsButtonRef, fileInputRef, selectedImages, setSelectedImages, dialogComp, setDialogComp }: NoteEditorActionToolbarProps) {
    ...
    const dialogDropdownMenu = useAppSelector((state) => state.actionToolbar.dialogDropdownMenu); // The state of the dialog dropdown menu
        ...
        <>
            {
                breakPointForFullscreenDialog === false ?
                    <div className={note_editor_styles.editor_actions}>
                                    ...
                                    <>
                                        {
                                            noteEditorDialogState ?
                                                <BackgroundOptionsToolbarForDialog
                        ...
                        <button onClick={() => closeEditor(editor, dialogComp, setDialogComp)} className={note_editor_styles.close_button}>Close</button>
