...
const DropletOffSVG: React.FC<SVGComponentProps> = (props) => (
  <svg
    ...
    className="icon icon-tabler icons-tabler-outline icon-tabler-droplet-off"
    {...props}
  >
