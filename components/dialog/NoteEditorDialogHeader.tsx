...
import NoteEditorDialogHeaderProps from '@/types/note-editor-dialog-header.types';
...
/**
 * This component is the header for the note editor dialog in fullscreen.
 */
export default function NoteEditorDialogHeader({ editor, dialogComp, setDialogComp }: NoteEditorDialogHeaderProps) {
    ...
    const undo = useAppSelector((state) => state.actionToolbar.undo); // The state of the undo action
    const redo = useAppSelector((state) => state.actionToolbar.redo); // The state of the redo action
